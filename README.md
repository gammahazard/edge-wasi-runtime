...
│                                                              │
│   ┌──────────────────────────────────────────────────────┐   │
│   │  GPIO Provider Capability (Host Implements)          │   │
│   │  • read_dht22(pin) → (temperature, humidity)        │   │
...
│   │         ┌──────────────┴──────────────┐              │   │
│   │         │ Python WASM Plugin          │              │   │
│   │         │  • imports gpio_provider    │              │   │
│   │         │  • calls read_dht22(4)     │              │   │
│   │         │  • returns real sensor data │              │   │
│   │         └─────────────────────────────┘              │   │
│   └──────────────────────────────────────────────────────┘   │
└──────────────────────────────────────────────────────────────┘
                            ↓
...
It must call `gpio_provider.read_dht22()` which the host controls.  
...
![Dashboard Demo](doc/screenshots/hotswapdashboard.mp4)
*Video: `doc/screenshots/hotswapdashboard.mp4`*

#### 2. Sensor Hot Swap (Logic Update)
![Sensor Demo](doc/screenshots/hotswapsensor.mp4)
*Video: `doc/screenshots/hotswapsensor.mp4`*
